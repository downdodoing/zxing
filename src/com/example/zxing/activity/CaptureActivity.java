...
import com.example.zxing.decoding.CaptureActivityHandler.DecodeCallback;
...
public abstract class CaptureActivity extends Activity implements Callback,
	 ...
	 */
	protected void init(Activity context, SurfaceView surfaceView,
	...
	public void handleDecode(Result result, Bitmap barcode) {
		...
		setResult(RESULT_OK,
				new Intent().putExtra(RESULT_QRCODE_STRING, resultString));
		finish();
	}
